...
function remFav1() {
   var currentFav = document.getElementById("getfav1")
   currentFav.innerHTML = "";
   mainCount--;
}
function remFav2() {
   var currentFav = document.getElementById("getfav2")
   currentFav.innerHTML = "";
   mainCount--;
}
function remFav3() {
   var currentFav = document.getElementById("getfav3")
   currentFav.innerHTML = "";
   mainCount--;
}
function remFav4() {
   var currentFav = document.getElementById("getfav4")
   currentFav.innerHTML = "";
   mainCount--;
}
function remFav5() {
   var currentFav = document.getElementById("getfav5")
   currentFav.innerHTML = "";
   mainCount--;
}
